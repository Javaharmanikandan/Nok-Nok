...
import MediaHouseTabBar from './MediaHouseTabBar';
      ...
      <Image source={data.image} style={styles.image}/>
        ...
        <View style={styles.headerText}>
            ...
            <View style={styles.subTitle}>
                <Text style={styles.subTitleText}>{data.interviews}</Text> 
                <Text style={styles.subTitleText}>|</Text> 
                <Text style={styles.subTitleText}>{data.followers}</Text>  
             </View>
             <TouchableOpacity style={[styles.button,
                {backgroundColor: data.selected ? colors.CardBackground : colors.FollowBtnBG,
                    width: data.selected ? 100 : 62}]}> 
...
export default MediaHouseProfile
